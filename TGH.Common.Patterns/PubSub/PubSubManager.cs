...
namespace TGH.Common.Patterns.PubSub
{
	public static class PubSubManager
	{
		...
		/// The type of event to subscribe to.  All event types must implement <see cref="IPubSubEvent"/>
		/// </typeparam>
		...
		/// </summary>
		/// <typeparam name="EventType">
		/// The type of event being unsubscribed from.  All event types must implement <see cref="IPubSubEvent"/>
		/// </typeparam>
